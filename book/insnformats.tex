...
\foreach \x in {1,...,#1}%
	%\draw(\x,0) node{\tt\substring{#2}{\x}{\x}};%
...
\newcommand\DrawInsnBitstring[3]{
	\pgfmathsetmacro\num{int(#1-1)}
	\foreach \x in {1,2,...,#1}
    	\draw(\x+.25,-.3) node[text width = 10, text height = 1]{\tt\substring{#2}{\x}{\x}};
	\draw(#1+1,0) node[right]{\tt#3};
}
...
\newcommand\DrawInsnBoxSeg[4]{
	...
	\node at (\posn,1.2) {\small\tt#4};			% the field label
...
\newcommand\DrawInsnBoxRelTop[3]{
	...
	\node at (\posn,.75) {\small\tt#3};				% the field label
}
...
%    	\draw(\x,0) node{\substring{\strut #1}{\x}{\x}};
		\draw(\x+.25,.5) node[text width = 10, text height = 1]{\tt\substring{#1}{\x}{\x}};
}
...
%	\node at (32,\ArrowSouth+2) {0};
	...
	\begin{scope}[shift={(0,-19.75)}]
		...
		\end{scope}
		\DrawInsnBoxRel{31}{0}{}
		\draw(33,.5) node[text width = 10, text height = 1, right]{\tt imm\_j};
...
%	\node at (32,\ArrowSouth+2) {0};
	...
	\begin{scope}[shift={(0,-19.75)}]
		...
		\end{scope}
		\DrawInsnBoxRel{31}{0}{}
		\draw(33,.5) node[text width = 10, text height = 1, right]{\tt imm\_b};
...
\newcommand\InsnOpSTypeDecoding{
	...
	\begin{scope}[shift={(0,-19.75)}]
		...
		\end{scope}
		\DrawInsnBoxRel{31}{0}{}
		\draw(33,.5) node[text width = 10, text height = 1, right]{\tt imm\_s};
...
\newcommand\InsnOpITypeDecoding{
	...
	\begin{scope}[shift={(0,-19.75)}]
		...
		\end{scope}
		\DrawInsnBoxRel{31}{0}{}
		\draw(33,.5) node[text width = 10, text height = 1, right]{\tt imm\_i};
...
%	\draw[red,->](\ZeroNodeX+.5,\ZeroNodeY)to[out=0,in=110](27,\ArrowSouth);	
	...
	\begin{scope}[shift={(-8,-19.75)}]
		...
		\end{scope}
		\DrawInsnBoxRel{4}{0}{}
		\draw(33,.5) node[text width = 10, text height = 1, right]{\tt shamt\_i};
	...
	\begin{scope}[shift={(-24,-19.75)}]
		...
		\end{scope}
		\DrawInsnBoxRel{0}{0}{}
		\draw(33,.5) node[text width = 10, text height = 1, right]{\tt srai/srli};
...
\newcommand\InsnOpUTypeDecoding{
	...
	\begin{scope}[shift={(0,-19.75)}]
		...
		\end{scope}
		\DrawInsnBoxRel{31}{0}{}
		\draw(33,.5) node[text width = 10, text height = 1, right]{\tt imm\_u};
